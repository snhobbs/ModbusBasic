...
namespace ModbusBasic_input_register {
...
class Wrapper {
 ...
 private:
  input_register* data_bank_{};

 public:
  explicit Wrapper(input_register* data_bank) : data_bank_{data_bank} {}
  static const constexpr std::size_t size() { return sizeof(input_register); }
