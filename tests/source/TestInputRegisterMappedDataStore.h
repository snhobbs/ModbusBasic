 ...
 * Autogenerated file: 2020-05-28T09:03:22.989021
 */
...
class DataMap {
 ...
 public:
    ...
    switch (identifier) {
      ...
      case (MemoryMapEntryIdentifier::str20): {
        for (std::size_t i = 0;
          ...
          data_bank_.str20[i] = data_view[i];
        }
  ...
  ArrayView<const uint8_t> get_str20(void) const {
    return ArrayView<const uint8_t>{20, GetDataBank().str20};
  }
  void set_str20(const uint8_t* const value, std::size_t length) {
    for (std::size_t i = 0; i < length; i++) {
      GetDataBank().str20[i] = value[i];
    }
  }
  ...
  uint32_t get_int16(void) const { return GetDataBank().int16; }
  void set_int16(uint32_t value) { GetDataBank().int16 = value; }
